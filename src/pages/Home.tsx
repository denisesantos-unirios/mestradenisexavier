...
const courses = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: "aula-4", title: "Aula 4", description: "Engenharia de Requisitos", path: "/engenharia-software-2/aula-4" },
      { id: "aula-5", title: "Aula 5", description: "Requisitos: Fundamentos", path: "/engenharia-software-2/aula-4-fundamentos" },
      { id: "aula-6", title: "Aula 6", description: "Mini-Mundo e Entrega", path: "/engenharia-software-2/aula-5" },
      { id: "aula-7", title: "Aula 7", description: "Técnicas de Elicitação", path: "/engenharia-software-2/aula-6" },
      { id: "aula-8", title: "Aula 8", description: "Ferramentas e Dinâmica", path: "/engenharia-software-2/aula-7" },
      { id: "aula-9", title: "Aula 9", description: "Documento de Requisitos", path: "/engenharia-software-2/aula-8" },
      { id: "aula-10", title: "Aula 10", description: "Técnicas de Validação", path: "/engenharia-software-2/aula-9" },
      { id: "aula-11", title: "Aula 11", description: "Entrega Fase 2", path: "/engenharia-software-2/aula-10" },
      { id: "aula-12", title: "Aula 12", description: "UML e Diagramas", path: "/engenharia-software-2/aula-11" },
      { id: "aula-13", title: "Aula 13", description: "Diagrama de Casos de Uso", path: "/engenharia-software-2/aula-12" },
      { id: "aula-14", title: "Aula 14", description: "Especificação de Casos de Uso", path: "/engenharia-software-2/aula-13" },
      { id: "aula-15", title: "Aula 15", description: "Workshop Prático", path: "/engenharia-software-2/aula-14" },
      { id: "aula-16", title: "Aula 16", description: "Entrega Fase 3", path: "/engenharia-software-2/aula-15" },
      { id: "aula-17", title: "Aula 17", description: "User Stories & Kanban", path: "/engenharia-software-2/aula-16" },
      { id: "aula-18", title: "Aula 18", description: "Diagrama de Classes", path: "/engenharia-software-2/aula-17" }
    ]
  },
  {
    ...
    lessons: [
      { id: "aula-1", title: "Aula 1", description: "Conceitos da engenharia de software", path: "/engenharia-software-ead/aula-1" },
      { id: "aula-2", title: "Aula 2", description: "Melhorias de processos de Software", path: "/engenharia-software-ead/aula-2" },
      { id: "aula-3", title: "Aula 3", description: "Ciclos de Desenvolvimento de Sistemas, Metodologia Ágil e Scrum", path: "/engenharia-software-ead/aula-3" },
      { id: "aula-4", title: "Aula 4", description: "Métodos ágeis", path: "/engenharia-software-ead/aula-4" },
      { id: "aula-11", title: "Aula 5", description: "Projeto de banco de dados: modelos conceitual, lógico e físico", path: "/engenharia-software-ead/aula-11" },
      { id: "aula-9", title: "Aula 6", description: "Modelagem ágil", path: "/engenharia-software-ead/aula-9" },
      { id: "aula-5", title: "Aula 7", description: "Requisitos de software", path: "/engenharia-software-ead/aula-5" },
      { id: "aula-6", title: "Aula 8", description: "Aplicação de técnicas de elicitação de requisitos de software", path: "/engenharia-software-ead/aula-6" },
      { id: "aula-7", title: "Aula 9", description: "Conhecer e construir Diagrama de Casos de Uso", path: "/engenharia-software-ead/aula-7" },
      { id: "aula-10", title: "Aula 10", description: "Revisão Final", path: "/engenharia-software-ead/aula-10" },
      { id: "aula-8", title: "Aula 11", description: "Estudo de Caso: Modelagem E-Commerce", path: "/engenharia-software-ead/aula-8" },
    ]
  },
  {
