...
import ConteudoSection, { HeroSection } from "@/components/engenharia-software-ead/aula11/ConteudoSection";
...
const Aula11 = () => (
  <main className="min-h-screen relative" style={{ background: "var(--gradient-hero)" }}>
    <LessonNavigation sections={sections} title="Aula 11 - Modelagem Conceitual" course="Engenharia de Software EAD" />
    <div className="pt-16">
      <HeroSection />
      <LessonQRCode />
      <ConteudoSection />
    ...
    <PdfExportButton filename="ES-EAD_Aula-11_Modelagem-Conceitual.pdf" />
  </main>
);
