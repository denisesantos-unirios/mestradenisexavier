...
const Aula2 = () => (
  <main className="min-h-screen relative" style={{ background: "var(--gradient-hero)" }}>
    <LessonNavigation sections={sections} title="Gestão de Projetos - ENADE • Aula 2" course="Gestão de Projetos" />
    <div className="pt-16">
      <HeroSection />
      <LessonQRCode />
    ...
    <PdfExportButton filename="Gestao-Projetos_ENADE_Aula-2.pdf" />
  </main>
);
