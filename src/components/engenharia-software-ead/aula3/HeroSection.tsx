    ...
    <div className="container mx-auto px-6 text-center relative z-10">
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
        ...
        <h1 className="text-5xl md:text-7xl font-black mb-6">
          <span className="bg-gradient-to-r from-violet-400 via-purple-400 to-fuchsia-400 bg-clip-text text-transparent">Ciclos de Desenvolvimento</span>
          <br /><span className="text-foreground text-3xl md:text-4xl">Metodologia Ágil & Scrum</span>
        </h1>
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">Do Cascata ao Scrum: papéis, artefatos, cerimônias e histórias de usuário (INVEST)</p>
      </motion.div>
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1 }} className="absolute bottom-10 left-1/2 -translate-x-1/2">
        <a href="#metodologias" className="flex flex-col items-center gap-2 text-muted-foreground hover:text-violet-400 transition-colors">
