  ...
  if (dismissed) {
    return (
      <>
        ...
        <DenyChat open={chatOpen} onClose={() => setChatOpen(false)} />
      </>
    );
  }
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex items-center gap-1 text-xs font-medium text-white bg-primary hover:opacity-90 rounded-md px-2 py-1"
                  >
