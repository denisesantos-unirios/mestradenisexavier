  ...
  return (
    <section id="hero" className="section-container relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 animate-fade-up-delay-1 leading-tight">
          <span className="text-foreground">Crise do </span>
          <span className="accent-text">Software</span>
        </h1>

        <p className="text-xl md:text-2xl text-muted-foreground mb-12 animate-fade-up-delay-2 max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-16 animate-fade-up-delay-3">
