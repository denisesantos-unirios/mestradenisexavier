...
import { Sparkles, MousePointer, Layers, ChevronDown } from "lucide-react";
...
const features = [
  {
    ...
    description: "Sistemas que respondem ao usuário"
  },
  {
    icon: Layers,
    title: "Qualidade de Uso",
    description: "Eficiência, eficácia e satisfação"
  },
  {
    icon: Sparkles,
    title: "Experiência",
    description: "Além da funcionalidade"
  }
];
      ...
      <div className="section-container text-center">
        ...
        <ScrollReveal animation="blur" delay={0.2}>
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            O que é
            <br />
            <span className="accent-text">Design de Interação?</span>
          </h1>
        </ScrollReveal>

        <ScrollReveal animation="fadeUp" delay={0.4}>
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto mb-12">
            Conceitos fundamentais sobre como projetamos a 
            <span className="text-foreground font-medium"> comunicação entre pessoas e sistemas</span>.
          </p>
        </ScrollReveal>
        ...
        <ScrollReveal animation="scale" delay={0.6}>
          ...
          >
            <span className="font-medium">Explorar Conceitos</span>
